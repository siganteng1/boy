          ...
          if (!m.key.fromMe && !isCreator) return reply(lang.ownerOnly())
             asukonyol11 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `ShinChan Senpai × Leenz XD`,
                            "jpegThumbnail": fs.readFileSync("./image/lol.jpg")
                        } 
                    } 
                }
            await alpha.sendMessage(m.chat, {text:"Turu"},{quoted:asukonyol11})
            await alpha.sendMessage(m.chat, {text:"NGONTOL"},{quoted:asukonyol11})
            }
            break  
case 'family100': {
